...
function main() {
    return __awaiter(this, void 0, void 0, function () {
        var _i, bowlingTypes_1, type;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    console.log('🌱 Seeding bowling types...');
                    _i = 0, bowlingTypes_1 = bowlingTypes;
                    _a.label = 1;
                case 1:
                    if (!(_i < bowlingTypes_1.length)) return [3 /*break*/, 4];
                    type = bowlingTypes_1[_i];
                    return [4 /*yield*/, prisma.bowlingType.upsert({
